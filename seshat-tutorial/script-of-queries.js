...
var q2 = {
    text:`The second stage is creating a topic taxonomy which will allow us to group together related properties by topic`, 
    insert: `WOQL.when(true, 
        WOQL.and(
...
let q10 = {
    insert: `WOQL.boxClasses("scm:", ["tcs:Document", "scm:Enumerated", "scm:SupraPolityRelations"], ["scm:Confidence", "scm:Topic", "scm:ScopedValue"])`,
    query: `WOQL.and(
        WOQL.quad("v:Class", "rdf:type", "owl:Class", "db:schema"),
...
let q13 = {
    ...
    insert: `WOQL.with("graph://temp", ${remote_or_file}("${rdf_source}", {"type":"turtle"}),
    WOQL.when(
        WOQL.and(
            WOQL.quad("v:AID","v:First_Pred","v:Join","graph://temp"),
            WOQL.quad("v:Join","v:Second_Pred","v:Target","graph://temp"),
